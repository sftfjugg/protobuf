...
fn test_default_accessors() {
    ...
    assert_that!(msg.default_sfixed32(), eq(49));
    assert_that!(msg.default_sfixed64(), eq(-50));
    assert_that!(msg.default_float(), eq(51.5));
    assert_that!(msg.default_double(), eq(52000.0));
...
fn test_optional_float_accessors() {
    ...
    assert_that!(msg.optional_float_opt(), eq(Optional::Set(3.14)));
    assert_that!(msg.optional_float(), eq(3.14));
